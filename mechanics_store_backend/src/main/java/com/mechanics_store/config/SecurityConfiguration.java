...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                //                .requestMatchers(HttpMethod.POST, "/api/v1/cars/**").hasAuthority("CLIENT")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/reservations/**").hasAuthority("CLIENT")
                //                .requestMatchers(HttpMethod.GET, "/api/v1/brands/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.GET, "/api/v1/models/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.GET, "/api/v1/engines/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.GET, "/api/v1/cars/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.GET, "/api/v1/reservations/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/brands/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/models/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/engines/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/cars/**").hasAuthority("WORKER")
                //                .requestMatchers(HttpMethod.POST, "/api/v1/reservations/**").hasAuthority("WORKER")
